        ...
        return (
            <div className={styles.teamsCont}>
                ...
                <div className={styles.teamname}>
                    <h1 className={styles.headingteamsa}>{teamName}</h1>
                    <div className={styles.teamname_body}>
                        {WEB.map((s) => <Card id={s.id} name={s.name} alt={s.alt} img={s.img} designation={s.designation} />)}
                    </div>
                </div>
        ...
        return (
            <div className={styles.teamsCont}>
                ...
                <div className={styles.teamname}>
                    <h1 className={styles.headingteamsa}>{teamName}</h1>
                    <div className={styles.teamname_body}>
                        {APP.map((s) => <Card id={s.id} name={s.name} alt={s.alt} img={s.img} designation={s.designation} />)}
                    </div>
                </div>
        ...
        return (
            <div className={styles.teamsCont}>
                ...
                <div className={styles.teamname}>
                    <h1 className={styles.headingteamsa}>{teamName}</h1>
                    <div className={styles.teamname_body}>
                        {UI.map((s) => <Card id={s.id} name={s.name} alt={s.alt} img={s.img} designation={s.designation} />)}
                    </div>
                </div>
        ...
        return (
            <div className={styles.teamsCont}>
                ...
                <div className={styles.teamname}>
                    <h1 className={styles.headingteamsa}>{teamName}</h1>
                    <div className={styles.teamname_body}>
                        {EVENT.map((s) => <Card id={s.id} name={s.name} alt={s.alt} img={s.img} designation={s.designation} />)}
                    </div>
                </div>
    ...
    return (
        <div className={styles.teamsCont}>
            ...
            <div className={styles.teamname}>
                <h1 className={styles.headingteamsa}>{teamName}</h1>
                <div className={styles.teamname_body}>
                    {HACKATHON.map((s) => <Card id={s.id} name={s.name} alt={s.alt} img={s.img} designation={s.designation} />)}
                </div>
            </div>
