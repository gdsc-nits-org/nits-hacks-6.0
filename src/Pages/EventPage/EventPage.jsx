...
const EventPage = () => {
	const data = [
		...
		},
		{
			...
			para2: "Guidelines: 1. A team of 2-3 members from the same college can participate in the contest. 2. An eligible individual is allowed to join only one team. 3. It's crucial to register the team through the provided link below, compliance will result in disqualification",
